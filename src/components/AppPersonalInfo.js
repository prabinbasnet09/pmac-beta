                          ...
                          <tr>
                            <td>
                              <input
                                ...
                                value={mcat.chemical}
                                onChange={e =>
                                  setMCAT({ ...mcat, chemical: e.target.value })
                                }
                            ...
                            <td>
                              <input
                                ...
                                value={mcat.critical}
                                onChange={e =>
                                  setMCAT({ ...mcat, critical: e.target.value })
                                }
                          ...
                          <tr>
                            ...
                            <td>
                              <input
                                ...
                                onChange={e =>
                                  setDAT({ ...dat, perceptual: e.target.value })
                                }
                                className='w-full px-2 py-1 border-gray-300 focus:outline-none focus:ring-2'
                              />
                            </td>
                                ...
                                <div className='mt-10 w-full md:mt-10'>
                                  <div className='mt-5 mb-5 text-black font-bold text-2lg mx-auto'>
                                    <p className='leading-relaxed text-justify'>
                                      ...
                                      semester and summer during your collegiate
                                      career. Please use additional paper if
                                      necessary. Where applicable, provide
                                      numbers of hours associated with that task
                                      per week.
                                    </p>
                                  </div>
