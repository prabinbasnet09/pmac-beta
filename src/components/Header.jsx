  ...
  return (
    <div className='flex justify-between items-center h-10 max-w-[1240px] mx-auto px-4 text-[#3B0000]'>
       <h1 className='w-full text-3xl font-bold text-ulm_red'>ULM</h1>
           ...
           <button className='bg-ulm_red w-[100px] rounded-md text-lg my-6 mx-auto font-bold px-2 text-white'>Login
                   </button>
           </a>
       ...
       <div className={nav ? 'fixed left-0 top-0 w-[40%] h-full border-r z-40 border-stone-900 bg-[#ffffff] ease-in-out duration-500' : 'fixed left-[-100%] text-black'}>
