            ...
            <div className='border-2 border-[#7e7e7e] rounded-xl shadow-xl shadow-[#7092BE] shadow:opacity-20 w-4/5 mx-auto mb-7 px-4 py-5 sm:p-6 '>
              ...
              <div className=' p-4 text-black opacity-75 mx-auto'>
                <p className='leading-relaxed text-justify'>
                  ...
                  Department as soon as possible. You may be contacted by a
                  member of the Pre-Professional Health Advisory Committee
                  seeking additional information or verification. By signing
                  below the undersigned student hereby waives his/her right of
              ...
              <div>
                ...
                <div className=' p-4 text-black opacity-75 mx-auto'>
                  <p className='text-justify'>
                    ...
                    circling the appropriate description in the table below and
                    answering the following questions. Thank you for your
              ...
              <div className='mt-10'>
                ...
                <div>
                  <p className='font-bold mt-14'>
                    ...
                    sign below and return this form to Dr. Allison Wiedemeier
                    (326 CNSB).
                  </p>
