              ...
              <div className="px-4 py-5 sm:p-6">
                <div className="grid grid-cols-6 gap-6">
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    />
                    {errors.firstName && (
                      <span className="inline-flex text-sm text-bred">
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    {errors.number && (
                      <span className="inline-flex text-sm text-bred">
                        Please enter your correct Phone number [xxx-xxx-xxxx].
                      </span>
                    )}
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    {errors.state && (
                      <span className="inline-flex text-sm text-bred">
                        Please enter your correct State/Province.
                      </span>
                    )}
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-3 lg:col-span-2">
                    ...
                    {errors.zip && (
                      <span className="inline-flex text-sm text-bred">
                        Please enter your correct Zip/Postal Code [x-xxxxx].
                      </span>
                    )}
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    {errors.ulm && (
                      <span className="inline-flex text-sm text-bred">
                        Please enter your correct ULM email address
                        [...@warhawks.ulm.edu].
                      </span>
                    )}
                  </div>
                  ...
                  <div className="col-span-6 sm:col-span-3">
                    ...
                    {errors.alternate && (
                      <span className="inline-flex text-sm text-bred">
                        Please enter your correct Alternate email address
                        [...@example.com].
                      </span>
                    )}
                  </div>
